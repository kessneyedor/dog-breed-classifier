...
def classify_images(images_dir, results_dic, model):
    ...
    for filename in results_dic:
        ...
        # Call the classifier function to get the raw prediction
        raw_label = classifier(full_path, model)

        # Clean up: lowercase and strip leading/trailing whitespace
        classifier_label = raw_label.lower().strip()
